...
provide('topics', readonly(topics))

const activeTopic = ref<Topic | undefined>(undefined)
...
onMounted(() => {
  setTimeout(() => {
    topics.push({
      id: 'events',
      title: 'Events',
      description: 'Nigger Nigger Nigger',
      fullText: 'Nigger nigger nigger nigger',
    })
  }, 3000)
})
</script>
